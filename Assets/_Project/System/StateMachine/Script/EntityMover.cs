...
public class EntityMover : MonoBehaviour
{
	...
	private void HandleNormalMovement() => _rigidbody.linearVelocity = MoveDirection*GetEffectiveMoveSpeed();
	...
	{
		if (TryGetComponent(out IStatProvider statProvider) && statProvider.EntityStats != null)
			return moveSpeed*statProvider.EntityStats.MoveSpeedMultiplier;
	...
	{
		if (currentOverrideState == OverrideMovementState.Charging) ClearOverride();
	}
	...
	public void StopMeleeLunge()
	{
		if (currentOverrideState == OverrideMovementState.Melee) ClearOverride();
	}
}
