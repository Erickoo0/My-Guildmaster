...
[CreateAssetMenu(fileName = "QuestDatabase", menuName = "Quest/Quest Database", order = 0)]
public class QuestDatabase : ScriptableObject
{
    ...
    public void SetupDictionary()
    {
        ...
        foreach (QuestSo quest in questDatabase)
        {
            ...
            {
                Debug.LogWarning($"[QuestDatabase] Duplicate Quest ID found: {quest.QuestID}. IDs must be unique!");
            }
        }
    }
    ...
    public QuestSo GetQuestByID(string questID)
    {
        ...
        Debug.LogWarning($"Quest Database: Could not find questID with ID '{questID}'");
        return null;  
    }
