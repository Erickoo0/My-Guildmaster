...
/// <summary>
/// Base blueprint SO for a quest
/// </summary>
[CreateAssetMenu(fileName = "FILENAME", menuName = "QuestUI/QuestUI", order = 0)]
public class QuestSo : ScriptableObject
{
	...
	private List<QuestObjectiveBase> questObjectives = new List<QuestObjectiveBase>();
