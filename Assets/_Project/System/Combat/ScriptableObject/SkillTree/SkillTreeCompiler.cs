...
public static class SkillTreeCompiler
{
	...
	/// </summary>
	public static SkillDataInstance CompileSkillDataInstance(SkillTree skillTree)
	{
		// Safety Check
		if (skillTree == null)
		{
			Debug.LogWarning("SkillTreeCompiler: Cannot compile because SkillTree is null");
			return null;
		}
	...
	/// </summary>
	public static SkillTreeLedger GetOrCreateSkillTreeLedger(SkillTree skillTree)
	{
		if (skillTree == null || skillTree.SkillData == null)
		{
			Debug.LogWarning("SkillTreeCompiler: Cannot create SkillTreeLedger because SkillTree or skillData is null");
			return null;
		}
	...
	private static void ApplySkillNodeModifiers(SkillNode skillNode, int pointsAllocated, SkillDataInstance skillDataInstanceCompiled)
	{
		...
		for (int i = 0; i < pointsAllocated; i++)
			foreach (ModifierSkillBase modifier in skillNode.Modifiers)
				if (modifier != null)
					modifier.ApplyModifier(skillDataInstanceCompiled);
	}
}
