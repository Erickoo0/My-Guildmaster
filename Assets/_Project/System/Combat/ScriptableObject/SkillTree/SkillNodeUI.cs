...
public class SkillNodeUI : MonoBehaviour
{
    ...
    private System.Action _onSkillNodeChanged; 
    
    public enum NodeState {Locked, Available, Allocated, Maxed}

    
    public void Setup(SkillNode skillNode, SkillTree skillTree, SkillTreeLedger skillTreeLedger, System.Action onSkillNodeChanged)
    {
